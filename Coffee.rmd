...
# par(mfrow = c(2, 3),oma=c(4, 2, 0, 0)+0.1)
# 
# plot(x = test_coffee_df$InSpecies, y = test_coffee_df$e_hat,
#                       main = "Residual vs. Species", xlab = "Species",
#                       ylab = "Residual")
# plot(x = test_coffee_df$Aroma, y = test_coffee_df$e_hat,
#                     main = "Residual vs. Aroma", xlab = "Aroma",
#                     ylab = "Residual")
# plot(x = test_coffee_df$Flavor, y = test_coffee_df$e_hat,
#                      main = "Residual vs. Flavor", xlab = "Flavor",
#                      ylab = "Residual")
# plot(x = test_coffee_df$Aftertaste, y = test_coffee_df$e_hat,
#                     main = "Residual vs. Aftertaste", xlab = "Aftertaste",
#                     ylab = "Residual")
# plot(x = test_coffee_df$Acidity, y = test_coffee_df$e_hat,
#                       main = "Residual vs. Acidity", xlab = "Acidity",
#                       ylab = "Residual")
# plot(x = test_coffee_df$Sweetness, y = test_coffee_df$e_hat,
#                     main = "Residual vs. Sweetness", xlab = "Sweetness",
#                     ylab = "Residual")
# mtext(~italic("Fig.4: All residuals versus predictors plots from the model."), side = 1, line = 3, outer = TRUE, adj = 0.5)
...
# test
# qqnorm(test_coffee_df$e_hat)
# qqline(test_coffee_df$e_hat)
...
# test
# plot(x = test_coffee_df$y_hat, y = test_coffee_df$Ratings, main = "Response vs. Fitted", xlab = "Fitted", 
#      ylab = "Response")
# title(sub = ~italic("Fig.2: The reponse (coffee ratings) versus fitted values plot from the model."))
```
